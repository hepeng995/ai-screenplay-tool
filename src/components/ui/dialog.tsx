      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-md mx-4 rounded-xl border border-zinc-200 bg-white shadow-lg dark:border-zinc-700 dark:bg-zinc-900"
          >
            <div className="p-6">
              <h2
                id="dialog-title"
